...
import CodeBlock from '../../components/general/CodeBlock.astro'
...
<CodeBlock title="~/.config/fish/config.fish">
...
<CodeBlock title="~/.config/nvim/init.lua">
...
<CodeBlock title="~/.config/nvim/lua/plugins.lua">
...
<CodeBlock title="keybindings.json">
...
<CodeBlock title=".stylelintrc.cjs">
