...
The only shell I use is [Fish](https://fishshell.com/). Colorful, great autocomplete support, nice Git integration (e.g., it displays the current branch name in the right side of the command line). [Nushell](https://www.nushell.sh/) seems cool too, but not being POSIX-compliant scares me a bit. I also use [Oh My Posh](https://ohmyposh.dev/) with the [gruvbox](https://github.com/JanDeDobbeleer/oh-my-posh/blob/main/themes/gruvbox.omp.json) theme to customize my prompt.
...
> 🚧 **Update (05 / 04 / 2026).** I just replaced my Neovim configs with [LazyVim](https://www.lazyvim.org/). No additional settings for the moment.
>
> ![Rust projects inside LazyVim](../../assets/posts/lazyvim.png)
