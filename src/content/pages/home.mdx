...
My name is **Iulian Oleniuc**, I'm {new Date() < new Date(new Date().getFullYear(), 2, 21) ? new Date().getFullYear() - 2003 : new Date().getFullYear() - 2002} years old, and I'm a master's student in Advanced Studies in Computer Science at Alexandru Ioan Cuza University of Iași. My research focuses on cryptography, specifically on **Key-Policy Attribute-Based Encryption**. I'm passionate about mathematics, science, and hip-hop culture.
...
- In high school, I earned a silver 🥈 and a bronze 🥉 medal at **NOI** (National Olympiad in Informatics).
- For 4 years, I was a member of the scientific committee of the **FIICode** contest.
- For 3 years, I conducted lessons at the **InfoGym** computer science circle.
